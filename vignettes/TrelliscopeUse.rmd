...
summary(objects[1][[1]])
summary(filterpipe(objects[1][[1]], cv_threshold = 120, min_num = 3,
           min_nonmiss_gtest = NULL, min_nonmiss_anova = 2))

summary(objects[2][[1]])
summary(filterpipe(objects[2][[1]], cv_threshold = 120, min_num = 3,
           min_nonmiss_gtest = 3, min_nonmiss_anova = 2))

summary(objects[3][[1]])
summary(filterpipe(objects[3][[1]], cv_threshold = 120, min_num = 3,
           min_nonmiss_gtest = 3, min_nonmiss_anova = 2))

summary(objects[4][[1]])
summary(filterpipe(objects[4][[1]], cv_threshold = 120, min_num = 3,
           min_nonmiss_gtest = 3, min_nonmiss_anova = 2))

summary(objects[5][[1]])
summary(filterpipe(objects[5][[1]], cv_threshold = 120, min_num = 3,
           min_nonmiss_gtest = 3, min_nonmiss_anova = 2))

summary(objects[6][[1]])
summary(filterpipe(objects[6][[1]], cv_threshold = 120, min_num = 3,
           min_nonmiss_gtest = 3, min_nonmiss_anova = 2))
...
objects[4][[1]] <- filterpipe(objects[4][[1]], cv_threshold = 120, min_num = 3,
                              min_nonmiss_gtest = 3, min_nonmiss_anova = 2)    # pep_object
...
### cnames only updates for "combined" right now, needs to be added to other tests??
## or not?? NULL returns
attributes(imd_anova(norm_objects[6][[1]], test_method = "combined"))$cnames
attributes(imd_anova(norm_objects[6][[1]], test_method = "anova"))$cnames
attributes(imd_anova(norm_objects[6][[1]], test_method = "gtest"))$cnames
...
boxplot(techrep$comp_stats$Fold_change[!is.na(techrep$comp_stats$Fold_change)])
